...
<form action="StudentView.jsp" method="post">
  ...
  <a href="./UserServlet?action=Tz_AddTeacher_Xuanke&userid=<%
        ArrayList<Teacher> teachers=(ArrayList<Teacher>) request.getAttribute("teachers");
        Teacher teacher=teachers.get(0);
        out.print(teacher.getUserid());
    %>">添加教授课程</a>
</form>
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <c:forEach items="${teachers}" var="teacher">
    <tr>
      ...
      <td width=10% align="center"><a href="javascript:void(0);"onclick="deleteBook(${teacher.courseid})">删除</a></td>
    </tr>
  </c:forEach>
</table>
</body>
