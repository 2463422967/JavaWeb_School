...
<head>
  <title>学院</title>
  <link href="css/school%20inf.css" rel="stylesheet" type="text/css"/>
</head>
<body>
...
<table border="0" width=70% cellpadding="0" cellspacing="0">
  ...
  <c:forEach items="${xys}" var="xy">
    <tr>
      ...
      <td width=100% align="center"><a href="./UserServlet?action=SelectClassByXueYuan&collegeid=${xy.collegeid}&tzname=student">${xy.collegename}</a></td>
